...
<html lang="en">
<head>
<title>Prefabrication a Real Estate  Category Flat Bootstrap responsive Website Template | Home :: w3layouts</title>
...
<div class="welcome">
	<div class="container">
		<div class="agileits-title">
			...
			<p class="top-p">Mauris vestibulum ac sem at ornare. Praesent
				feugiat metus pellentesque, finibus massa quis, viverra lacus. Ut
				nisi ante, dignissim sit amet justo pretium.</p>
		</div>
		<div class="w3ls-row alert">
		  ...
		  <div class="welcome-agiletext">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tincidunt lorem sed velit fermentum lobortis. Fusce eu semper lacus, eget placerat mauris. Sed lectus tellus, sodales id elit a, feugiat porttitor nulla. Sed porta magna vitae nisl vulputate lacinia. Morbi malesuada sollicitudin tortor, vitae pharetra nunc lacinia eget. Nulla ornare purus nunc, ut dapibus leo sodales adipiscing. Praesent sit amet justo diam. Quisque sagittis egestas sem vitae vestibulum.  </p>
				<a href="#myModal" data-toggle="modal" class="more">Read More</a>
			</div>
		</div> -->
			<div class="clearfix"></div>
		</div>
...
<div class="reservation-info"> 
	<div class="reservation">
		<div class="container">			
			...
			<h2 class="agileits-title w3title2">Better Rates</h2>
			<h4>By using better</h4>
			<p>Mauris vestibulum ac sem at ornare. Praesent feugiat metus pellentesque, finibus massa quis, viverra lacus. Ut nisi ante, dignissim sit amet justo pretium.</p>
				<form action="#" method="post">  
					...
					<div class="col-md-5 make">
						<input type="submit" value="CHECK YOUR RATE">
					</div>
					<div class="clearfix"> </div>
				</form> 
			</div>
