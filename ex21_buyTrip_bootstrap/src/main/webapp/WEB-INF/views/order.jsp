...
<html lang="en">
<head>
<title>Prefabrication a Real Estate  Category Flat Bootstrap responsive Website Template | Services :: w3layouts</title>
...
<!-- 							<div class="w3_agileits_services_grid1r">
						...
						<h4>
							<a href="#" data-toggle="modal" data-target="#myModal">London ▷ Seoul</a>
						</h4>
<!-- 						<p>Etiam quis placerat dui, sit amet tristique nisl. Donec
							eget finibus eros.</p> -->
					</div>
				</div>
				<div class="col-md-4 w3_agile_services_grid">
					...
					<div class="agileits_w3layouts_services_grid1">
						...
						<h4>
							<a href="#" data-toggle="modal" data-target="#myModal">lobortis
								sem dictum placerat</a>
						</h4>
						<p>Etiam quis placerat dui, sit amet tristique nisl. Donec
							eget finibus eros.</p>
					</div>
				...
				<div class="col-md-4 w3_agile_services_grid">
					...
					<div class="agileits_w3layouts_services_grid1">
						<div class="w3_agileits_services_grid1">
							...
							<div class="clearfix"></div>
							<h4>
								<a href="#" data-toggle="modal" data-target="#myModal">Praesent
									amet tempor risus</a>
							</h4>
							<p>Etiam quis placerat dui, sit amet tristique nisl. Donec
								eget finibus eros.</p>
				...
				<div class="col-md-4 w3_agile_services_grid">
					...
					<div class="agileits_w3layouts_services_grid1">
						...
						<h4>
							<a href="#" data-toggle="modal" data-target="#myModal">Nullam
								sed eros fermentum</a>
						</h4>
						<p>Etiam quis placerat dui, sit amet tristique nisl. Donec
							eget finibus eros.</p>
					</div>
				...
				<div class="col-md-4 w3_agile_services_grid">
					...
					<div class="agileits_w3layouts_services_grid1">
						...
						<h4>
							<a href="#" data-toggle="modal" data-target="#myModal">Suspendisse
								ultrices sed mollis</a>
						</h4>
						<p>Etiam quis placerat dui, sit amet tristique nisl. Donec
							eget finibus eros.</p>
					</div>
		...
		<div class="services-bottom">
			<div class="container">
				<div class="agileits_services_bottom_grid">
					<h3>
						the great aim of <span>education</span> is not knowledge but
						action
					</h3>
					<p>Nullam laoreet vestibulum condimentum. Cras elit nisl,
						consequat sed sollicitudin ac faucibus, cursus vitae nisl.</p>
				</div>
			</div>
		</div>
		<!-- //services-bottom -->
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="agileits-w3layouts-info">
							<img
								src="${pageContext.request.contextPath}/resources/images/g8.jpg"
								alt="" />
			...
			<div class="container">
				...
				<div class="footer-btm-agileinfo">
					<div class="col-md-3 col-xs-3 footer-grid">
						...
						<ul>
							<li><a href="#"><i
									class="glyphicon glyphicon-menu-right"></i>Hendrerit quam</a></li>
							<li><a href="#"><i
									class="glyphicon glyphicon-menu-right"></i>Amet consectetur </a></li>
							<li><a href="#"><i
									class="glyphicon glyphicon-menu-right"></i>Iquam hendrerit</a></li>
							<li><a href="#"><i
									class="glyphicon glyphicon-menu-right"></i>Donec ut lectus </a></li>
						</ul>
					</div>
					...
					<div class="col-md-6 col-xs-6 footer-grid footer-review">
						...
						<div class="copy-w3lsright">
							<p>
								© 2017 Prefabrication. All rights reserved | Design by <a
