								...
								<div class="well well-lg"
									...
									<div class="row" style="margin: 0px;">
										...
										<div class="col-sm-11" style="margin: 10px;">
											<h2>${highestDealDTO.departNation}</h2>
										</div>
									</div>
									<div class="row" style="margin: 0px;">
										<img alt=""
									...
									<div class="row" style="text-align: center;">
										<div class="col-xs-4">
											<h3>
												<span>${highestDealDTO.orderNumber}</span>
											</h3>
										</div>
										<div class="col-xs-4">
											<h3>
												<span>${highestDealDTO.completedDealNumber}</span>
											</h3>
										</div>
										<div class="col-xs-4">
											<h3>
												<span>${highestDealDTO.deal} %</span>
											</h3>
										</div>
									</div>
									<div class="row" style="height: 15px;"></div>
									...
									<div class="well well-sm"
										...
										<div class="row">
											...
											<div class="col-xs-9 col-md-9 section-box"
												...
												<h2>
													${productDTO.productName} <a href="http://bootsnipp.com/"
														target="_blank"><span
