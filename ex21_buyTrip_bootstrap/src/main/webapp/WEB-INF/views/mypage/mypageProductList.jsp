								...
								<div class="container">
									<div class="row">
										<div class="col-md-8">
											...
											<!-- 상품 한개 템플릿 -->
											<div class="panel panel-default  panel--styled" style="padding:10px;" onclick="location.href='${pageContext.request.contextPath}/detail'">
													<div align="right">
														...
														<div class="col-xs-9 col-md-9 section-box"
															...
															<div class="row">
																...
																<div class="col-sm-7" align="right">
																	<button type="button" class="btn btn-info" onclick="location.href='${pageContext.request.contextPath}/detail'">제안하기</button>
																</div>
															</div>
