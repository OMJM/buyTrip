...
<script>
	$(function(){
		$("#deleteDeal").click(function(){
			$.ajax({
				  url:"${pageContext.request.contextPath}/deal/deleteDeal",		
				  type:"post",		//get or post
				  dataType:"text",  //요청 결과 데이터 타입 text, html, json, xml
				  data:"name=김준영",		//서버에게 보낼 파라미터 정보
			...
			<div class="row profile">
				...
				<div class="col-md-9">
					<div class="profile-content">
						<!-- head부분 -->
						<h1 class="page-header">배달 내역 관리</h1>
						<!-- content tab부분. -->
						<div>
							<ul class="nav nav-tabs nav-justified">
								<li class="active"><a href="#tabb1" data-toggle="tab">대기중인 배달 목록</a></li>
								<li><a href="#tabb2" data-toggle="tab">확정된 배달 목록</a></li>
								<li><a href="#tabb3" data-toggle="tab">역대 배달 목록</a></li>
							</ul>
							<br>
						</div>
							...
							<div class="tab-pane fade in active" id="tabb1">
								<div class="container">
									<div class="row">
										<div class="col-md-8">
										<c:choose>
												<c:when test="${empty requestScope.offerJoinProductList}">
													<tr>
														<td colspan="5">
															<p align="center">
													...
													<c:otherwise>
													<c:forEach items="${requestScope.offerJoinProductList}" var="offerJoinProductDTO">
														<!-- 상품 한개 템플릿 -->
														<!--  
															...
															<div class="row">
																...
																<div class="col-xs-9 col-md-9 section-box"
																	...
																	<div class="well well-sm">
																		...
																		<small>주문번호 : </small>${offerJoinProductDTO.offerCode}<br>
																	</div>
																	<div class="row">
																		<div class="col-sm-5" style="font-size: 20px;">
																		...
																		<div class="col-sm-7" align="right">
																			...
																			<form method="POST" action="${pageContext.request.contextPath}/deal/deleteDeal"/>
																				<input type="submit" class="btn btn-info"
																					id="deleteDeal" value="배달 취소"/>
																				<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
																				<input type="hidden" name="offerCode" value="${offerJoinProductDTO.offerCode}"/>
																				<!-- <input type="hidden" name="productDTO" value="${offerJoinProductDTO.productDTO}"/> -->
																			</form> 
																		</div>
																	</div>
